    ...
    <b-row class="auth-inner m-0">
      ...
      >
        ...
        >
          ...
          >
            {{$t('titles.'+'Forgot your password')}}
          </b-card-title>
          <b-card-text class="mb-2">
            {{$t('subtitles.'+'Enter your email and we will send you the instructions to reset your password')}}
          </b-card-text>
          ...
          <validation-observer ref="simpleRules">
            ...
            >
              <b-form-group>
                <label for="forgot-password-email">{{$t('titles.'+'login.email')}}</label>
                <validation-provider
                  #default="{ errors }"
                  name="Email"
