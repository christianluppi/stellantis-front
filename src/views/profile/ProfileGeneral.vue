  ...
  <b-card>
    ...
    <b-media no-body>
      ...
      <b-media-body class="mt-75 ml-75">
        ...
        <!--/ reset -->
        <b-card-text>Se permite JPG, GIF o PNG. Tamaño maximo de 800kB</b-card-text>
      </b-media-body>
    </b-media>
    <!--/ media -->
      ...
      <b-row>
        ...
        <b-col sm="6">
          ...
          >
            <b-form-input
              id="account-country"
              v-if="optionsLocal.country"
              v-model="optionsLocal.country.name"
              name="country"
              placeholder="Pais"
              disabled
            />
        ...
        <b-col cols="12">
          ...
          <b-button
            ...
            type="reset"
            class="mt-2"
            @click.prevent="resetForm && $router.go(-1)"
          >
            Cancelar
          </b-button>
        </b-col>
